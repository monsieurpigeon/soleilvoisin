...
export const metadata: Metadata = {
  title: "Factions — Soleil Voisin",
  description:
    "Les factions de Soleil Voisin — bientôt disponible. En attendant, découvrez la galerie pastel.",
};
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-lg text-center">
        ...
        <p className="mt-6 text-base leading-relaxed text-zinc-400 sm:text-lg">
          ...
          <em className="text-zinc-300">Soleil Voisin</em> arrivent prochainement.
        </p>
